...
public class RazeCore {
  ...
  public static var secondayRazeColor: UIColor {
  ...
  /// - Parameters:
  ///   - hexString: A 6-digit hexadecimal string. User 6 digits rather than 8, and add the accompanying alpha value in the second parameter
