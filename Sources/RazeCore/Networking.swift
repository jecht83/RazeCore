...
extension RazeCore {
  public class Networking {
    ...
    public class Manager {
      ...
      // MARK: - Body
      /// Calls to the live internet to retrieve Data from specific location
      /// - Parameters:
